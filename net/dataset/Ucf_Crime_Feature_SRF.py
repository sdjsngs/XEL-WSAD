...
class Ucf_Crime_Feature_SRF(Dataset):
    """
    UCF Crime dataset
    trianing:
    800 normal
...
if __name__=="__main__":
    ...
    data_loader=DataLoader(Ucf_Crime_Feature_SRF(mode="train",cfg=cfg),batch_size=1,shuffle=False)
    #
    for step ,(a_feature,a_label,_) in enumerate(data_loader):
        print("step",step)
        print(a_feature.shape,a_label.shape)
