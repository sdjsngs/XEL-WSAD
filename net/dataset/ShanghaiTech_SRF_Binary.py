...
binary version return one normal and one abnormal video feature
...
class SH_SRF_Binary(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # load one feature
        # in binary dataset  return one normal and one abnormal video feature
        if self.mode in ["train"]:
...
if __name__=="__main__":
    ...
    data_loader=DataLoader(SH_SRF_Binary(mode="update_epoch",cfg=None),batch_size=1,shuffle=False)
    #
